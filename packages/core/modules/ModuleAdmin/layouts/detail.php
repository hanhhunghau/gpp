...
<?php if(URL::get('cmd')=='delete'){?><td width="1%" nowrap="nowrap" class="form_title_button"><a  onclick="ModuleAdminForm.submit();"><img src="<?php echo PageSetting::template('core').'/images/buttons/';?>delete_button.gif" style="text-align:center" alt=""/><br />[[.Delete.]]</a></td><?php }else{ if(User::can_edit()){?><td class="form_title_button"><a href="<?php echo URL::build_current(array('cmd'=>'edit','id'));?>"><img src="<?php echo PageSetting::template('core').'/images/buttons/';?>edit.jpg" style="text-align:center" alt=""/><br />[[.Edit.]]</a></td><?php } if(User::can_delete()){?><td class="form_title_button">
	...
	'name'=>isset($_GET['name'])?$_GET['name']:'',  
	  ));?>"><img src="<?php echo PageSetting::template('core').'/images/buttons/';?>go_back_button.gif" style="text-align:center" alt=""/><br />[[.back.]]</a></td>
	  	<td class="form_title_button" width="1%" nowrap="nowrap"><a target="_blank" href="<?php echo URL::build_current(array('cmd'=>'export','module_id'=>URL::get('id')));?>"><img src="<?php echo PageSetting::template('core').'/images/buttons/';?>export_button.gif" style="text-align:center"/><br />[[.export.]]</a></td>
				</tr></table>

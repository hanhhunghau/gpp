...
<table width="100%" border="0" cellpadding="1" cellspacing="0">
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
        <tr>
          <td><img src="<?php echo PageSetting::template('core');?>/images/OK_1.gif" /></td>
		  <td nowrap="nowrap" width="100%" align="center" background="<?php echo PageSetting::template('core');?>/images/OK_2.gif"><span style="text-transform:uppercase;color:#000066">&nbsp;&nbsp;::&nbsp;&nbsp;&nbsp;[[.export_module.]]&nbsp;&nbsp;&nbsp;&nbsp;::</span></td>
          <td><img src="<?php echo PageSetting::template('core');?>/images/OK_3.gif" /></td>
        </tr>
      </table>

      ...
      <tr valign="top">
		...
		<table width="100%" border="0" cellpadding="3" cellspacing="0">
            ...
            <tr valign="top">
              ...
              <td valign="top"><a href="<?php echo URL::build_current(array('cmd'=>'delete'));?>&id=[[|items.id|]]"><strong><img src="<?php echo PageSetting::template('core');?>/images/buttons/delete.gif" width="12" height="12" border="0" ></strong></a></td>

  ...
  <tr>
	...
	function title_label($name,$label)
	{
		if(Url::get('order_by')==$name)
		{
			...
			if(Url::get('dir')=='desc') 
			{
				echo ' <img alt="Click to order ascending" src="'.PageSetting::template('core').'/images/icon/downarrow.gif">';
			}
			else
			{
				echo ' <img alt="Click to order descending" src="'.PageSetting::template('core').'/images/icon/uparrow.gif">';
			}
		}
		else
		{
